...
function(read_targetconfig)
  ...
  foreach(CPUNAME ${MISSION_CPUNAMES})
    ...
    # message(STATUS "global_functions.cmake: Configuring for ${CPUNAME}")
    # if(CPUNAME STREQUAL "cpu1")
    #   add_definitions(-DCPU1)
    #   remove_definitions(-DCPU2)
    # elseif(CPUNAME STREQUAL "cpu2")
    #   add_definitions(-DCPU2)
    #   remove_definitions(-DCPU1)
    # else()
    #   message(FATAL_ERROR "Invalid CPUNAME ${CPUNAME}. Must be 'cpu1' or 'cpu2'")
    # endif()
